...
def get_dialogo_rects():
    # Ajustar o tamanho do balão de fala
    balao_largura = 750
    balao_altura = 150
    balao_topo = 520
    
    return [
        dialogos[0].get_rect(topleft=(60, balao_topo + 10)),
        dialogos[1].get_rect(topleft=(60, balao_topo + 40)),
        dialogos[2].get_rect(topleft=(60, balao_topo + 10)),
        dialogos[3].get_rect(topleft=(60, balao_topo + 40)),
        dialogos[4].get_rect(topleft=(60, balao_topo + 10)),
        dialogos[5].get_rect(topleft=(60, balao_topo + 40)),
        dialogos[6].get_rect(topleft=(60, balao_topo + 10)),
        dialogos[7].get_rect(topleft=(60, balao_topo + 40)),
        dialogos[8].get_rect(topleft=(60, balao_topo + 70)),
        dialogos[9].get_rect(topleft=(60, balao_topo + 40)),
        dialogos[10].get_rect(topleft=(60, balao_topo + 70))
    ]
...
def initialize_variables():
    return {
        ...
        'rodando': True,
        'tam_alt': (150, 0),
        'resposta_correta': 2  # A resposta correta é 2
    }
...
def draw_alternativas(tela, variables):
    ...
    # Captura de cliques e verificação da resposta
    pos_mouse = pygame.mouse.get_pos()
    if pygame.mouse.get_pressed()[0]:
        if altb_rect.collidepoint(pos_mouse):
            print('Acertou')
            # Chame a próxima função ou passe para a próxima fase aqui
        elif alta_rect.collidepoint(pos_mouse) or altc_rect.collidepoint(pos_mouse) or altd_rect.collidepoint(pos_mouse):
            print('Errou')
            # Chame a função de erro ou feedback negativo aqui
